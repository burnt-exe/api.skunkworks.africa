...
/**
 * Menubar — composable, accessible command/menu bar built on Radix primitives.
 * Fully themeable with Tailwind and integrates with ShadCN styling conventions.
 */

// ----------------------------------------------------------------------------
// Re-exports for primitive building blocks
// ----------------------------------------------------------------------------
